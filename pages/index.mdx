...
Start deploying your [projects](https://docs.pipeops.io/docs/registration) in minutes.
...
Now let's get you started. To begin, you'll need to [create an account ](https://docs.pipeops.io/docs/quick-setup)👌🏽.